...
stripchart <- stripchart + ylab("Price") + xlab("Temp_keep_in_h_if_power_outage") + labs(colour = "Rank")
stripchart <- stripchart + ggtitle("Refrigerator comparison") + theme(plot.title = element_text(vjust =+ 2))
stripchart
